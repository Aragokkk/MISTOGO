        ...
        <div className="navbar-row">
          ...
          <div className="navbar-left">
            ...
            <div className="navbar-links">
              ...
              <NavLink to="/zones" className={linkClass}>{t('zones.short_zone')}</NavLink>
          ...
          <div className="navbar-right">
            <NavLink to="/support" className="navbar-link">{t('contacts')}</NavLink>
            <NavLink to="/faq" className="navbar-link">{t('faq.short')}</NavLink>
            ...
            >
              <svg width="59" height="31" viewBox="0 0 59 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_228_816)">
                  ...
                  <g className="toggle-circle" style={{ transform: isDarkMode ? 'translateX(28px)' : 'translateX(0)', transition: 'transform 0.3s ease' }}>
