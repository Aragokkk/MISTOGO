  ...
  const scooters = [
    {
      ...
      power: t('scooters_page.scooters.scooter1.power'),
      range: t('scooters_page.scooters.scooter1.range'),
      price: t('scooters_page.scooters.scooter1.price'),
      year: t('scooters_page.scooters.scooter1.year')
    },
    {
      id: 2,
      name: 'Kugoo S3 Pro',
      image: '/image/scooter/kugoo-s3.png',
      power: t('scooters_page.scooters.scooter2.power'),
      range: t('scooters_page.scooters.scooter2.range'),
      price: t('scooters_page.scooters.scooter2.price'),
      year: t('scooters_page.scooters.scooter2.year')
    },
    {
      id: 3,
      name: 'Ninebot Max G30',
      image: '/image/scooter/ninebot-max.png',
      power: t('scooters_page.scooters.scooter3.power'),
      range: t('scooters_page.scooters.scooter3.range'),
      price: t('scooters_page.scooters.scooter3.price'),
      year: t('scooters_page.scooters.scooter3.year')
    },
    {
      id: 4,
      name: 'Kugoo M4 Pro',
      image: '/image/scooter/kugoo-m4.png',
      power: t('scooters_page.scooters.scooter4.power'),
      range: t('scooters_page.scooters.scooter4.range'),
      price: t('scooters_page.scooters.scooter4.price'),
      year: t('scooters_page.scooters.scooter4.year')
    },
    {
      id: 5,
      name: 'Xiaomi Mi Scooter 3',
      image: '/image/scooter/xiaomi-3.png',
      power: t('scooters_page.scooters.scooter5.power'),
      range: t('scooters_page.scooters.scooter5.range'),
      price: t('scooters_page.scooters.scooter5.price'),
      year: t('scooters_page.scooters.scooter5.year')
    },
    {
      id: 6,
      name: 'Ninebot ES2',
      image: '/image/scooter/ninebot-es2.png',
      power: t('scooters_page.scooters.scooter6.power'),
      range: t('scooters_page.scooters.scooter6.range'),
      price: t('scooters_page.scooters.scooter6.price'),
      year: t('scooters_page.scooters.scooter6.year')
    }
  ];
