  ...
  const bikes = [
    {
      ...
      power: t('bikes_page.bikes.bike1.power'),
      range: t('bikes_page.bikes.bike1.range'),
      price: t('bikes_page.bikes.bike1.price'),
      year: t('bikes_page.bikes.bike1.year')
    },
    {
      id: 2,
      name: 'Eleglide M1 Plus',
      image: '/image/bike/eleglide-m1.png',
      power: t('bikes_page.bikes.bike2.power'),
      range: t('bikes_page.bikes.bike2.range'),
      price: t('bikes_page.bikes.bike2.price'),
      year: t('bikes_page.bikes.bike2.year')
    },
    {
      id: 3,
      name: 'Fiido D11',
      image: '/image/bike/fiido-d11.png',
      power: t('bikes_page.bikes.bike3.power'),
      range: t('bikes_page.bikes.bike3.range'),
      price: t('bikes_page.bikes.bike3.price'),
      year: t('bikes_page.bikes.bike3.year')
    },
    {
      id: 4,
      name: 'Samebike LO26',
      image: '/image/bike/samebike-lo26.png',
      power: t('bikes_page.bikes.bike4.power'),
      range: t('bikes_page.bikes.bike4.range'),
      price: t('bikes_page.bikes.bike4.price'),
      year: t('bikes_page.bikes.bike4.year')
    },
    {
      id: 5,
      name: 'Xiaomi Himo Z20',
      image: '/image/bike/xiaomi-himo-z20.png',
      power: t('bikes_page.bikes.bike5.power'),
      range: t('bikes_page.bikes.bike5.range'),
      price: t('bikes_page.bikes.bike5.price'),
      year: t('bikes_page.bikes.bike5.year')
    },
    {
      id: 6,
      name: 'Eleglide T1 Step-Thru',
      image: '/image/bike/eleglide-t1.png',
      power: t('bikes_page.bikes.bike6.power'),
      range: t('bikes_page.bikes.bike6.range'),
      price: t('bikes_page.bikes.bike6.price'),
      year: t('bikes_page.bikes.bike6.year')
    }
  ];
  ...
  return (
    <div className="bikes-page">
      ...
      <div className="page-header-section">
        ...
        <h1 className="page-main-title">{t('bikes_page.title')}</h1>
      </div>
    ...
    <clipPath id="clip0_989_4364">
      ...
      <section className="other-transport-section">
        <div className="section-content">
          <h2 className="section-title">{t('bikes_page.other_transport_title')}</h2>
          ...
          <div className="transport-cards">
            <div className="transport-card" onClick={() => navigate("/transport/cars")}>
              ...
              >
                {t('bikes_page.select_button')} <span>»</span>
              </button>
            </div>
