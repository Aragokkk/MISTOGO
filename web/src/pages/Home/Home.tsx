...
function Home() {
  ...
  const handleNextReview = () => {
    setCurrentReviewIndex(
      (prev) => (prev + 1) % Math.ceil(reviews.length / 2)
    );
  };
        ...
        <div className="promo-banner">
          ...
          <div className="promo-content">
            <h3 className="promo-title">
              Спробуй еко-транспорт уже сьогодні —
              <br />
              отримай знижку 10% на перше
              <br />
              бронювання!
            </h3>
            ...
            <div className="popular-card">
              <div className="card-badge">
                ...
                >
                  ...
                  <path
                    d="M2 11.1498V21.8502M14.7643 11.1498C15.2479 11.1498 15.7117 10.9619 16.0537 10.6274C16.3957 10.293 16.5878 9.83936 16.5878 9.36637V4.12494C16.5072 3.72105 16.5719 3.30234 16.7709 2.93979C16.97 2.57724 17.2911 2.29316 17.6798 2.13571C18.0685 1.97826 18.501 1.95713 18.9038 2.0759C19.3066 2.19467 19.6551 2.44604 19.8901 2.78738L32.3553 14.9788C32.5597 15.1786 32.7218 15.4159 32.8325 15.6771C32.9431 15.9383 33 16.2182 33 16.5009C33 16.7836 32.9431 17.0635 32.8325 17.3247C32.7218 17.5858 32.5597 17.8231 32.3553 18.023L19.8901 30.2126C19.6551 30.554 19.3066 30.8053 18.9038 30.9241C18.501 31.0429 18.0685 31.0217 17.6798 30.8643C17.2911 30.7068 16.97 30.4228 16.7709 30.0602C16.5719 29.6977 16.5072 29.2789 16.5878 28.8751V23.6336C16.5878 23.1606 16.3957 22.707 16.0537 22.3726C15.7117 22.0381 15.2479 21.8502 14.7643 21.8502H11.1174C10.6337 21.8502 10.1699 21.6623 9.82797 21.3279C9.486 20.9934 9.29388 20.5398 9.29388 20.0668V12.9332C9.29388 12.4602 9.486 12.0066 9.82797 11.6721C10.1699 11.3377 10.6337 11.1498 11.1174 11.1498H14.7643Z"
                    stroke="#4B4B4B"
                    strokeWidth="3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
