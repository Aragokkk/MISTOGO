...
function Home() {
  ...
  return (
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">
            Відкрий місто по-новому<br />
            з еко-транспортом
          </h1>
          
          <p className="hero-description">
            Авто, велосипеди, самокати і скутери — твій транспорт<br />
            на будь-які завдання тут і зараз
          </p>
        ...
        <div className="hero-image">
          <img 
            ...
            alt="Eco Transport - Car and Bike"
            width="2097"
            height="1180"
          />
        </div>
      ...
      {/* Transport and About Section - Combined */}
      <section className="transport-about-section">
        ...
        <div className="transport-cards">
          ...
          <div className="transport-card">
            <div className="transport-image">
              <img src="/image/Electrosamocat.png" 
              alt="Самокат" 
              width="329"
              height="406"/>
            </div>
        ...
        <div className="about-content-wrapper">
          ...
          <div className="about-content">
            <p className="about-text">
              Ми надаємо найдивні послуги оренди екологічного транспорту у вашому місті. 
              У нас доступні гібридні авто, велосипеди та електросамокати для коротких 
              і довгострокових поїздок. Оренда проста й швидка — достатньо пройти 
              спрощену перевірку документів.
            </p>
            ...
            <p className="about-text">
              ...
              та допомагаєте доглядати чистішим. Разом ми створюємо місто, яке є 
              сучасним, мобільним і дружнім до природи.
            </p>
          </div>
        </div>
      </section>
  ...
  <div className="popular-cards">
    ...
    <div className="popular-card">
      ...
      <div className="card-specs">
        <div className="spec-item">
          <svg width="39" height="26" viewBox="0 0 39 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M31.0769 16.5H35.2307C36.3353 16.5 37.2308 15.6046 37.2308 14.5V10.5" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" />
            <path d="M2.15387 16.5V22" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" />
            <path d="M8.30772 16H4.15387C3.0493 16 2.15387 16.8954 2.15387 18V20V12" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" />
            <path d="M8.9231 12.3433V20.1559C8.9231 21.1977 9.72279 22.065 10.7611 22.1493L14.5729 22.459C14.9037 22.4859 15.2226 22.5947 15.5009 22.7756L17.6568 24.1769C17.9812 24.3878 18.3598 24.5 18.7467 24.5H29.0769C30.1815 24.5 31.0769 23.6046 31.0769 22.5V10.5C31.0769 9.39543 30.1815 8.5 29.0769 8.5H12.8137C12.292 8.5 11.791 8.70382 11.4175 9.068L9.5269 10.9113C9.14082 11.2877 8.9231 11.8041 8.9231 12.3433Z" stroke="#4B4B4B" strokeWidth="3" />
        ...
        <div className="spec-item">
          <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.75 27.625H8.125M30.875 11.375H16.25" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M27.625 32.5C30.3174 32.5 32.5 30.3174 32.5 27.625C32.5 24.9326 30.3174 22.75 27.625 22.75C24.9326 22.75 22.75 24.9326 22.75 27.625C22.75 30.3174 24.9326 32.5 27.625 32.5Z" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11.375 16.25C14.0674 16.25 16.25 14.0674 16.25 11.375C16.25 8.68261 14.0674 6.5 11.375 6.5C8.68261 6.5 6.5 8.68261 6.5 11.375C6.5 14.0674 8.68261 16.25 11.375 16.25Z" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span>е-CVT</span>
        </div>
      </div>
      ...
      <div className="card-footer">
        ...
        <button className="card-button-white">Обрати</button>
      </div>
      
      <button className="card-button-green">Інші варіанти</button>
    </div>

    {/* Card 2 - E-bike Trek Powerfly */}
    <div className="popular-card">
      <div className="card-badge">
        <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="39" height="39" />
          <path d="M4.20225 28.2976C3.59271 28.907 3.25018 29.7335 3.25 30.5954V34.1249C3.25 34.5559 3.4212 34.9692 3.72595 35.2739C4.0307 35.5787 4.44402 35.7499 4.875 35.7499H9.75C10.181 35.7499 10.5943 35.5787 10.899 35.2739C11.2038 34.9692 11.375 34.5559 11.375 34.1249V32.4999C11.375 32.0689 11.5462 31.6556 11.851 31.3508C12.1557 31.0461 12.569 30.8749 13 30.8749H14.625C15.056 30.8749 15.4693 30.7037 15.774 30.3989C16.0788 30.0942 16.25 29.6809 16.25 29.2499V27.6249C16.25 27.1939 16.4212 26.7806 16.726 26.4758C17.0307 26.1711 17.444 25.9999 17.875 25.9999H18.1545C19.0164 25.9997 19.8429 25.6572 20.4523 25.0476L21.775 23.7249C24.0335 24.5116 26.4921 24.5086 28.7487 23.7164C31.0052 22.9241 32.9261 21.3895 34.1971 19.3636C35.4681 17.3377 36.0139 14.9404 35.7453 12.564C35.4767 10.1875 34.4096 7.97255 32.7184 6.28145C31.0273 4.59034 28.8124 3.52319 26.4359 3.25459C24.0595 2.98599 21.6622 3.53182 19.6363 4.80281C17.6104 6.0738 16.0758 7.99469 15.2835 10.2512C14.4913 12.5078 14.4883 14.9664 15.275 17.2249L4.20225 28.2976Z" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M26.8125 13C27.2612 13 27.625 12.6362 27.625 12.1875C27.625 11.7388 27.2612 11.375 26.8125 11.375C26.3638 11.375 26 11.7388 26 12.1875C26 12.6362 26.3638 13 26.8125 13Z" fill="#4B4B4B" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <span>Економія пального, ідеально для міста</span>
      </div>
      ...
      <div className="card-specs">
        <div className="spec-item">
          <svg width="37" height="23" viewBox="0 0 37 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.875 3.375L12 11.5H18.5L13.625 19.625M23.141 1.75H25C25.862 1.75 26.6886 2.09241 27.2981 2.7019C27.9076 3.3114 28.25 4.13805 28.25 5V18C28.25 18.862 27.9076 19.6886 27.2981 20.2981C26.6886 20.9076 25.862 21.25 25 21.25H20.2306M34.75 14.75V8.25M7.3525 21.25H5.5C4.63805 21.25 3.8114 20.9076 3.2019 20.2981C2.59241 19.6886 2.25 18.862 2.25 18V5C2.25 4.13805 2.59241 3.3114 3.2019 2.7019C3.8114 2.09241 4.63805 1.75 5.5 1.75H10.271" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span>30 км</span>
        </div>
    ...
    <div className="popular-card">
      <div className="card-badge">
        <svg width="35" height="33" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2 11.1498V21.8502M14.7643 11.1498C15.2479 11.1498 15.7117 10.9619 16.0537 10.6274C16.3957 10.293 16.5878 9.83936 16.5878 9.36637V4.12494C16.5072 3.72105 16.5719 3.30234 16.7709 2.93979C16.97 2.57724 17.2911 2.29316 17.6798 2.13571C18.0685 1.97826 18.501 1.95713 18.9038 2.0759C19.3066 2.19467 19.6551 2.44604 19.8901 2.78738L32.3553 14.9788C32.5597 15.1786 32.7218 15.4159 32.8325 15.6771C32.9431 15.9383 33 16.2182 33 16.5009C33 16.7836 32.9431 17.0635 32.8325 17.3247C32.7218 17.5858 32.5597 17.8231 32.3553 18.023L19.8901 30.2126C19.6551 30.554 19.3066 30.8053 18.9038 30.9241C18.501 31.0429 18.0685 31.0217 17.6798 30.8643C17.2911 30.7068 16.97 30.4228 16.7709 30.0602C16.5719 29.6977 16.5072 29.2789 16.5878 28.8751V23.6336C16.5878 23.1606 16.3957 22.707 16.0537 22.3726C15.7117 22.0381 15.2479 21.8502 14.7643 21.8502H11.1174C10.6337 21.8502 10.1699 21.6623 9.82797 21.3279C9.486 20.9934 9.29388 20.5398 9.29388 20.0668V12.9332C9.29388 12.4602 9.486 12.0066 9.82797 11.6721C10.1699 11.3377 10.6337 11.1498 11.1174 11.1498H14.7643Z" stroke="#4B4B4B" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <span>Економія пального, ідеально для міста</span>
      </div>
...
{/* Reviews Section */}
      <section className="reviews-section">
        ...
        <p className="reviews-subtitle">
          Ми дбаємо про зручність і надійність сервісу. Ось що кажуть ті, хто вже скористався орендою:
        </p>
      ...
      <footer className="footer-section">
        <div className="footer-top">
          <nav className="footer-nav">
            <a href="/transport" onClick={() => navigate('/transport')}>Транспорт</a>
            <a href="/zones" onClick={() => navigate('/zones')}>Паркування</a>
            <a href="/blog" onClick={() => navigate('/blog')}>Блог</a>
            <a href="/support" onClick={() => navigate('/support')}>Підтримка</a>
          </nav>
        ...
        <div className="footer-bottom">
          <div className="footer-legal">
            <a href="/privacy" onClick={() => navigate('/privacy')}>Правила та Умови</a>
            <a href="/confidentiality" onClick={() => navigate('/confidentiality')}>Конфіденційність</a>
          </div>
